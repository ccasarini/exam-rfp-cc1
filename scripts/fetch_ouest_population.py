...
def fetch_and_clip_population():
    ...
    compressed_path = "data/population_density/kontur_population_haiti.gpkg.gz"
    raw_gpkg_path = "data/population_density/kontur_population_haiti.gpkg"
    boundary_path = "data/borders/hti_admin1.geojson"
    output_path = "data/population_density/ouest_population_400m.geojson"
