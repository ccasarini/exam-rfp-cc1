...
- **Temporal Scope:** Data spans from **2017 to 2024** (the latest available), enabling a sliding timeline to track conflict evolution and assist in forecasting potential future escalations. This range was determined to be the most reliable after data cleaning.
